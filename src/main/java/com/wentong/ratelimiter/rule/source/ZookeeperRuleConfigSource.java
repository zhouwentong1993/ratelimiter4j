...
import com.wentong.ratelimiter.context.RateLimiterBeansFactory;
...
public class ZookeeperRuleConfigSource implements RuleConfigSource {
  ...
  public ZookeeperRuleConfigSource(String address, String path, RuleConfigParser ruleConfigParser) {
    ...
    this.path = path;
    this.ruleConfigParser = RateLimiterBeansFactory.BEANS_CONTEXT.obtainRuleConfigParser(ruleConfigParser);
  }
